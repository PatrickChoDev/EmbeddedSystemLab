...
/* Definitions for led_blue */
osTimerId_t led_blueHandle;
const osTimerAttr_t led_blue_attributes = {
  .name = "led_blue"
};
/* Definitions for led_green */
osTimerId_t led_greenHandle;
const osTimerAttr_t led_green_attributes = {
  .name = "led_green"
};
/* Definitions for led_red */
osTimerId_t led_redHandle;
const osTimerAttr_t led_red_attributes = {
  .name = "led_red"
};
/* Definitions for led_white */
osTimerId_t led_whiteHandle;
const osTimerAttr_t led_white_attributes = {
  .name = "led_white"
};
/* USER CODE BEGIN PV */
